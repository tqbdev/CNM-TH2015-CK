...
// valid address is a valid ecdsa key in the 04 + X-coordinate + Y-coordinate format
const isValidAddress = (address) => {
    if (address.length !== 130) {
        ...
        console.log('key must contain only hex characters');
        return false;
    } else if (!address.startsWith('04')) {
        console.log('key must start with 04');
        return false;
    }
    return true;
};
