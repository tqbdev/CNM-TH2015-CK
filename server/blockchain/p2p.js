...
const addBlockToChain = require  ('./blockchain').addBlockToChain;
const Block = require  ('./blockchain').Block;
const getBlockchain = require  ('./blockchain').getBlockchain;
const getLatestBlock = require  ('./blockchain').getLatestBlock;
const handleReceivedTransaction = require  ('./blockchain').handleReceivedTransaction;
const isValidBlockStructure = require  ('./blockchain').isValidBlockStructure;
